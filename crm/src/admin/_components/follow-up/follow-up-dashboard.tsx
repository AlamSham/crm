...
export default function FollowUpDashboard() {
  ...
  const recentCampaignsData = campaigns.slice(0, 5).map(campaign => ({
    ...
    totalContacts: campaign.contacts.length + campaign.contactLists.length,
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={8}>
            <Card size="small" className="text-center cursor-pointer hover:shadow-md transition-shadow">
              <MailOutlined className="h-8 w-8 text-blue-500 mx-auto mb-2" />
              <Text strong>Create Campaign</Text>
              <br />
              <Text type="secondary">Start a new email campaign</Text>
            </Card>
          </Col>
          
          <Col xs={24} sm={8}>
            <Card size="small" className="text-center cursor-pointer hover:shadow-md transition-shadow">
              <UserOutlined className="h-8 w-8 text-green-500 mx-auto mb-2" />
              <Text strong>Add Contacts</Text>
              <br />
              <Text type="secondary">Import or add new contacts</Text>
            </Card>
          </Col>
          
          <Col xs={24} sm={8}>
            <Card size="small" className="text-center cursor-pointer hover:shadow-md transition-shadow">
              <FileTextOutlined className="h-8 w-8 text-purple-500 mx-auto mb-2" />
              <Text strong>Create Template</Text>
              <br />
              <Text type="secondary">Design email templates</Text>
            </Card>
          </Col>
        </Row>
      </Card>
